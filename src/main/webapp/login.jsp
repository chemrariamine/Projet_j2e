					...
					<div class="signin-form">
						...
						<form method="post" action="loginServlet" class="register-form"
							...
							<div class="form-group">
								<label for="username"><i class="zmdi zmdi-account material-icons-name"></i></label> <input type="text" name="txtname" id="username" placeholder="Your Name" />
							</div>
							<div class="form-group">
								<label for="password"><i class="zmdi zmdi-lock"></i></label> <input
									type="password" name="txtmdp" id="password"
